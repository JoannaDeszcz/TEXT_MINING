...
#Tokenizacja - wyodrebnienie słów
...
stopwords = stopwords + ["pre","sta","dr"]
# stopwords
...
print(bow_naj_sort)#sortuje od najmniejszej do największej

#Wizualizacja

max_words = 50
plt.barh(range(max_words), list(bow_naj_sort.values())[:max_words], align='center')
plt.yticks(range(max_words), list(bow_naj_sort.keys())[:max_words])
